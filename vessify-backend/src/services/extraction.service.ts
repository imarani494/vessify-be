 ...
 */
function trySample1(text: string): ExtractedTransaction | null {
  ...
  if (!dateM || !descM || !amtM) return null;
 ...
 */
function trySample2(text: string): ExtractedTransaction | null {
 ...
 */
function trySample3(text: string): ExtractedTransaction | null {
